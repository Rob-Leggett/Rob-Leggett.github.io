...
import { InteractiveTerminal } from "@/components/layout/interactive-terminal";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:gap-6 lg:gap-8">
        ...
        <div className="mt-6 sm:mt-0 flex-1 text-center sm:text-left">
          ...
          >
            ...
            <span className="font-semibold text-primary">cloud and AI.</span>
          </motion.p>
          ...
          >
            ...
            >
              <a href="/resume/robert-leggett-resume.pdf" target="_blank" rel="noreferrer">
            ...
            <Button
              ...
              className="h-9 rounded-full px-4 border-primary/30 hover:border-primary hover:text-primary"
            >
              <a href="https://www.linkedin.com/in/rob-leggett/" target="_blank" rel="noreferrer">
            ...
            >
              <a href="https://github.com/Rob-Leggett" target="_blank" rel="noreferrer">
