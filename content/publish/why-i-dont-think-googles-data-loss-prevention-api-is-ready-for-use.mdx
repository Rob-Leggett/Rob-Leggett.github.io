...
**Info type**: CREDIT\_CARD\_NUMBER
...
Ensure you setup the required authentication of the service to allow for execution against your Google account: **export GOOGLE\_APPLICATION\_CREDENTIALS="/user//\[service-account-key\].json"**
