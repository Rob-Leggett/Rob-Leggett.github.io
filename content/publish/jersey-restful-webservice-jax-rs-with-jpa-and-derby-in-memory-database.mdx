...
status: "publish"
feature_image: "/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database/feature-image.png"
tags: ["Java", "Jersey", "RESTful API", "JAX-RS", "JPA", "Derby", "EclipseLink", "Genson", "Web Services", "Robert Leggett"]

meta:
  title: "Jersey RESTful WebService with JAX-RS, JPA, and Derby In-Memory Database | Java Tutorial by Robert Leggett"
  description: "A hands-on Java tutorial building a lightweight RESTful API using Jersey (JAX-RS), JPA with EclipseLink, and an in-memory Derby database — includes GitHub project link."
  keywords: ["Jersey REST API", "JAX-RS", "JPA", "Derby In-Memory Database", "EclipseLink", "Genson", "RESTful Web Services", "Java Tutorial", "Robert Leggett"]
  author: "Robert Leggett"
  canonical: "https://robertleggett.com.au/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database"
  image: "https://robertleggett.com.au/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database/feature-image.png"

og:
  type: "article"
  title: "Jersey RESTful WebService with JAX-RS, JPA, and Derby In-Memory Database"
  description: "Build a lightweight RESTful API using Jersey (JAX-RS), JPA (EclipseLink), and an in-memory Derby database — complete example with GitHub source."
  image: "https://robertleggett.com.au/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database/feature-image.png"
  url: "https://robertleggett.com.au/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database"

twitter:
  card: "summary_large_image"
  title: "Jersey RESTful WebService with JAX-RS, JPA, and Derby In-Memory Database"
  description: "Learn to build RESTful APIs in Java using Jersey, JPA, and Derby — includes source code and setup guide."
  image: "https://robertleggett.com.au/blog/jersey-restful-webservice-jax-rs-with-jpa-and-derby-in-memory-database/feature-image.png"
---
