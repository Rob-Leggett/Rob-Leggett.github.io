...
If you want to explore if Event Stream is the correct architecture choice for your situation, check out a previous article of mine - [Choosing Event Streaming or Messaging for your Architecture](https://robertleggett.blog/2020/03/02/choosing-event-streaming-or-messaging-for-your-architecture/)
