...
date: "2019-11-25"
slug: "deep-dive-dns"
feature_image: "/images/blog/deep-dive-dns-feature-image.png"
---
...
![DNS Sequence Flow Diagram](https://robertleggett.blog/wp-content/uploads/2019/10/how-dns-works-1.png?w=1024)
...
![Domain Name Diagram](https://robertleggett.blog/wp-content/uploads/2019/10/domain-name.png?w=1024)
...
![Domain Name Hierarchy Diagram](https://robertleggett.blog/wp-content/uploads/2019/10/domain-hierarchy-.png?w=1024)
...
![DNS resolving robertleggett.blog Diagram](https://robertleggett.blog/wp-content/uploads/2019/11/how-does-dns-resolver-work.png?w=1024)
...
![Local DNS cache Diagram](https://robertleggett.blog/wp-content/uploads/2019/11/dns-cache.png?w=660)
...
![DNS query flow Diagram](https://robertleggett.blog/wp-content/uploads/2019/11/dns-query.png?w=1024)
...
![DNS zone boundaries Diagram](https://robertleggett.blog/wp-content/uploads/2019/11/dns-zones-5.png?w=1024)
...
![DNS forwarders and root hint flow Diagram](https://robertleggett.blog/wp-content/uploads/2019/11/dns-forwarders-and-root-hints.png?w=1024)
...
The types of DNS records is quite extensive and can be found here [https://en.wikipedia.org/wiki/List\_of\_DNS\_record\_types](https://en.wikipedia.org/wiki/List_of_DNS_record_types)
